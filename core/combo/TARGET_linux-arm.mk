...
TARGET_TOOLCHAIN_ROOT := prebuilts/gcc/$(HOST_PREBUILT_TAG)/arm/$(ANDROID_EABI_TOOLCHAIN_DIR)
...
# This warning causes dalvik not to build with gcc 4.6.x/4.7.x/4.8.x/4.9.x and -Werror. 
